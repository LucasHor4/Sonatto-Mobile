      ...
      body: SafeArea(
        child: FutureBuilder<List<ProdutoClass>>(
          ...
          builder: (context, snapshot) {
            ...
            // Seções com limites
            final lancamentos = produtosList.toList(); // aqui você poderia filtrar se quiser
                ...
                SliverToBoxAdapter(
                  child: Center(
                    child: TextButton(
                      ...
                      child: Column(
                        children: [
                          Text(limite1 == 4 ? 'Ver mais' : 'Ver menos', style: TextStyle(color: Colors.grey),),
                          Divider( color: Colors.grey, thickness: 2, indent: 10, endIndent: 1, ),
                        ]
                        ),
                    ),
                  ),
                ...
                SliverToBoxAdapter(
                  child: Center(
                    child: TextButton(
                      ...
                      child: Column(
                        children: [
                          Text(limite2 == 4 ? 'Ver mais' : 'Ver menos', style: TextStyle(color: Colors.grey),),
                          Divider( color: Colors.grey, thickness: 2, indent: 10, endIndent: 1, ),
                        ]
                        ),
                    ),
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount: randomizados.length, // ou limite se quiser limitar aqui
                    ),
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      mainAxisSpacing: 8,
